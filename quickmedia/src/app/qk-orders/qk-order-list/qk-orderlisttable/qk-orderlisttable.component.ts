...
import { OrderData, viewOrder } from 'src/app/Models/qk.conversion.model';

@Component({
  selector: 'qk-orderlisttable',
  templateUrl: './qk-orderlisttable.component.html',
  styleUrls: ['./qk-orderlisttable.component.css']
})
export class QkOrderlisttableComponent implements OnInit {
