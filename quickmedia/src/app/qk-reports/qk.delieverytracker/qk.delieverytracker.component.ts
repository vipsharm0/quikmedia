...
@Component({
  selector: 'app-qk.delieverytracker',
  templateUrl: './qk.delieverytracker.component.html',
  styleUrls: ['./qk.delieverytracker.component.css']
})
export class QkDelieverytrackerComponent implements OnInit {
